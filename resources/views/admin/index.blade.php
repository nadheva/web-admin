                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flag">
                                                <img src="{{asset('template/')}}/assets/img/flags/DE.png">
                                            </div>
                                        </td>
                                        <td>Germany</td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flag">
                                                <img src="{{asset('template/')}}/assets/img/flags/GB.png">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="flag">
                                                <img src="{{asset('template/')}}/assets/img/flags/RO.png">
                                            </div>
                                        </td>
                                        <td>Romania</td>
                                        <td class="text-right">
...
<div class="row">
    <div class="col-md-4">
        <div class="card card-product">
            <div class="card-image" data-header-animation="true">
                <a href="#pablo">
                    <img class="img" src="{{asset('template/')}}/assets/img/card-2.jpg">
                </a>
            </div>
            <div class="card-content">
                <div class="card-actions">
    ...
    <div class="col-md-4">
        <div class="card card-product">
            <div class="card-image" data-header-animation="true">
                <a href="#pablo">
                    <img class="img" src="{{asset('template/')}}/assets/img/card-3.jpg">
                </a>
            </div>
            <div class="card-content">
                <div class="card-actions">
    ...
    <div class="col-md-4">
        <div class="card card-product">
            <div class="card-image" data-header-animation="true">
                <a href="#pablo">
                    <img class="img" src="{{asset('template/')}}/assets/img/card-1.jpg">
                </a>
            </div>
            <div class="card-content">
                <div class="card-actions">
